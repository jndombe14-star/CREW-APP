-- Push delivery for notifications: pg_net does the async HTTP call directly from
-- Postgres (no separate Edge Function to deploy/manage) — a real push, not a stub.
